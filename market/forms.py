...
class ProductForm(forms.ModelForm):
    class Meta:
        model = Product
        fields = ['title', 'category', 'description', 'marca', 'price', 'stock', 'image']
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Si estamos editando (instance existe), deshabilitar el campo title
        if self.instance and self.instance.pk:
            self.fields['title'].disabled = True
            self.fields['title'].widget.attrs['readonly'] = True
            self.fields['title'].help_text = 'El título no puede ser modificado'
